  ...
  return (
    <div className="px-4 mb-6">
      <div className="flex gap-3 overflow-x-auto scrollbar-hide">
        {/* Mobikwik Offer */}
        <div className="min-w-[200px] bg-white border border-gray-200 rounded-lg p-3 flex items-start gap-2 flex-shrink-0">
          <MdLocalOffer className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
