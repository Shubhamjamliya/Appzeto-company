...
const DiningTableSection = ({ onAddClick, onViewDetails }) => {
  const services = [
    {
      id: 1,
      ...
      options: '7 options',
      features: [
        'Dusting & wet wiping of furniture surfaces',
        'Wet shampooing of cushioned fabric chairs to remove tough stains',
      ],
      image: diningTable,
    },
  ];
  ...
  return (
    <div className="mb-6 border-t-4 border-gray-300 pt-6" id="dining-table">
      <div className="px-4 mb-4">
        <h2 className="text-xl font-bold text-black">Dining table</h2>
      </div>
...
export default DiningTableSection;
