...
const MattressSection = ({ onAddClick, onViewDetails }) => {
  const services = [
    {
      id: 1,
      ...
      features: [
        ...
        'Dry & wet vacuuming, shampooing for dust & tough stains',
      ],
      image: mattress,
    },
  ];
  ...
  return (
    <div className="mb-6 border-t-4 border-gray-300 pt-6" id="mattress">
      <div className="px-4 mb-4">
        <h2 className="text-xl font-bold text-black">Mattress</h2>
      </div>
