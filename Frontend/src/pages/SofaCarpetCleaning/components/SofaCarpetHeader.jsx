...
const SofaCarpetHeader = ({ onBack, onSearch, onShare, isVisible }) => {
  return (
    <header 
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-base font-semibold text-black">Sofa & Carpet Cleaning</h1>
...
export default SofaCarpetHeader;
